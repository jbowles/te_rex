module TeRex
  module Train
    BOOK = [
      "*I AND CANCEL UC HOTEL SEGMENT 01 NotProcessed BusinessLogic ERR.SWS.HOST.ERROR_IN_RESPONSE",
      "ALREADY_BOOKED",
      "AUTHENTICATION",
      ...
      "Hotel Booking Error (Booked rate exceeds quoted rate)",
      "Hotel Booking Error (Booking error Property Error)",
      "Hotel Booking Error (Booking error Rooms are no longer available)",
      "Hotel Booking Error (Booking error Try Again)",
      ...
      "HotelRoom_1 unavailable PRODUCT_UNAVAILABLE HotelId= : RateCode= : RoomCode= : RateAccessCode= : HostCode= : GuestCount= ",
      "ITINERARY_",
      ...
      "OMS_COMMUNICATION_FAILURE",
      "Only one room at a time may be reserved.",
      "PRICE_MISMATCH",
      "PROCESS_FAIL AGENT_ATTENTION Reservation Requires Agent to Confirm Agent waiting on supplier for confirmation number",
      "Please resubmit the booking request",
      "Postal code contains invalid (or insufficient) data",
      "Price Change happened for the given product from 100.60 to USD100.61 PRICE_CHANGED Price Change happened for the given product",
      ...
      "Room code invalid",
      "SOLD_OUT The room you were trying to book has sold out. Please choose another. errors.supplier.soldout: Hotel room type not found at this hotel. Please select a different room dates or or hotel.: 180",
      "Sold Out",
      ...
      "This product is currently not available PRODUCT_UNAVAILABLE ",
      "This product is currently not available. PRODUCT_UNAVAILABLE Requested product is not available.",
      "This product is currently not available. PRODUCT_UNAVAILABLE com.orbitz.tbs.model.ProductUnavailableException: Both Promoted and Unpromoted SellRates from the reprice should not be null\\n\\tat com.orbitz.tbs.hotel.txn.HotelReservationServiceImpl.validateHotelSelectInfo(HotelReservationServiceImpl.java:502)\\n\\tat com.orbitz.tbs.hotel.txn.HotelReservationServiceImpl.loadBookCriteria(HotelReservationServiceImpl.java:196)\\n\\tat com.orbitz.tbs.hotel.txn.HotelReservationServiceValidatingDecorator.loadBookCriteria(HotelReservationServiceValidatingDecorator.java:37",
      ...
      "Your first and last name may contain unusual or accented characters not recognized by our system. Also please make sure that you have not abbreviated your first or last name.",
      "Your reservation could not be accepted due to incorrect parameters.",
      ...
      "error.customer FileError",
      "error.customer FileError: Customer Add Failed",
