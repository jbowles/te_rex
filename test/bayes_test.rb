...
class BayesTest < MicroTest::Test
  @@refund = ["refundable", "- 1800 HOTEL TIME DAY OF ARRIVAL TO AVOID BILLING OF 1NT ROOM AND TAX OR FORFEITURE OF DEPOSIT "]

  @@partrefund = ["partial", "If you cancel or change your reservation before 6:00 PM on 9/11/14, the hotel will charge you $159. If you cancel or change your reservation after 6:00 PM on 9/11/14, the hotel will charge you for the total cost of your reservation."]
